...
<body>
    ...
    <div id="advDetail" v-show="nv1Status">
        ...
        <div class="container-fluid ctfloat hidden-xs nopd">
            <div class="row advBottomBg" style="background:url('images/T25C/T25C-022.png') no-repeat top center;background-size:cover;">
                <div class="col-sm-6 navFlexL">
                    <div class="leftNavFlex">
                        <div class="navWhatText">Why wait ? Order yours now .</div>
                        <div class="navNowBuy"><a href="http://item.jd.com/11563745630.html" target="view_window">立即购买</a></div>
                    </div>
                </div>
            ...
            <div class="row advBottomBg" style="background:url('images/T25C/T25C-022.png') no-repeat top center;background-size:cover;">
                ...
                <div class="col-sm-6 navFlexR">
                    <div class="leftNavFlex">
                        ...
                        <div class="navNowBuyA"><a href="http://item.jd.com/11563745630.html" target="view_window">立即购买</a></div>
                    </div>
                </div>
            </div>
        </div>
